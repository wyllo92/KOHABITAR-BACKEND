...
--
ALTER TABLE `cpcg_type`
  ADD PRIMARY KEY (`CPCG_type_id`);
...
ALTER TABLE `parkingzone`
  ADD PRIMARY KEY (`parkingZone_id`),
  ADD KEY `property_id` (`property_id`),
  ADD KEY `status_id` (`status_id`);
...
--
ALTER TABLE `parking_assignment`
  ADD PRIMARY KEY (`parking_Assignment_id`),
...
--
ALTER TABLE `cpcg`
  MODIFY `CPCG_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `cpcg_type`
--
ALTER TABLE `cpcg_type`
  MODIFY `CPCG_type_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `parkingslot`
  MODIFY `parkingSlot_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `parkingzone`
--
ALTER TABLE `parkingzone`
  MODIFY `parkingZone_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `parking_assignment`
--
ALTER TABLE `parking_assignment`
  MODIFY `parking_Assignment_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `user_property`
  MODIFY `user_property_id` int(10) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `amenity`
  ADD CONSTRAINT `amenity_ibfk_1` FOREIGN KEY (`status_id`) REFERENCES `status` (`status_id`),
...
--
ALTER TABLE `cpcg`
  ADD CONSTRAINT `cpcg_ibfk_1` FOREIGN KEY (`User_id`) REFERENCES `user` (`user_id`),
...
--
ALTER TABLE `module_role`
  ADD CONSTRAINT `module_role_ibfk_1` FOREIGN KEY (`module_id`) REFERENCES `module` (`module_id`),
...
--
ALTER TABLE `package`
  ADD CONSTRAINT `package_ibfk_1` FOREIGN KEY (`Status_id`) REFERENCES `status` (`status_id`),
...
--
ALTER TABLE `parkingslot`
  ADD CONSTRAINT `parkingslot_ibfk_1` FOREIGN KEY (`parkingZone_id`) REFERENCES `parkingzone` (`parkingZone_id`),
...
--
ALTER TABLE `parkingzone`
  ADD CONSTRAINT `parkingzone_ibfk_1` FOREIGN KEY (`property_id`) REFERENCES `property` (`property_id`),
...
--
ALTER TABLE `parking_assignment`
  ADD CONSTRAINT `parking_assignment_ibfk_1` FOREIGN KEY (`parkingSlot_id`) REFERENCES `parkingslot` (`parkingSlot_id`),
...
--
ALTER TABLE `permissions_module_role`
  ADD CONSTRAINT `permissions_module_role_ibfk_1` FOREIGN KEY (`module_role_id`) REFERENCES `module_role` (`module_role_id`),
...
--
ALTER TABLE `role`
  ADD CONSTRAINT `role_ibfk_1` FOREIGN KEY (`status_id`) REFERENCES `status` (`status_id`);
...
--
ALTER TABLE `tariff`
  ADD CONSTRAINT `tariff_ibfk_1` FOREIGN KEY (`status_id`) REFERENCES `status` (`status_id`);
...
--
ALTER TABLE `user_property`
  ADD CONSTRAINT `user_property_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`),
...
--
ALTER TABLE `visitor`
  ADD CONSTRAINT `visitor_ibfk_1` FOREIGN KEY (`Property_id`) REFERENCES `property` (`property_id`),
