...
<td>${row.role_id}</td>
<td>${row.role_name}</td>
<td>${row.role_description || 'N/A'}</td>
<td>${row.status_name || 'N/A'}</td>
<td>
<button type="button" title="Button Show"class="btn btn-success" onclick="showId(${row.role_id})"><i class='fas fa-eye'></i></button>
<button type="button"title="Button Edit" class="btn btn-primary" onclick="edit(${row.role_id})"><i class='fas fa-edit' ></i></button>
<button type="button" title="Button Delete" class="btn btn-danger" onclick="delete_(${row.role_id})"><i class='fas fa-trash' ></i></button> `;
